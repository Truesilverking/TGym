...
The replacement candidate is **1.15.32/code68**, superseding code67 for QA. Source `b0f497b6590e211f00fcbd1a68dac6593672f536` and QA tag `android-candidate-1.15.32-02` were pushed and verified remotely. [Tests 36220605423](https://github.com/Truesilverking/TGym/actions/runs/36220605423), [Android build/lint/emulator 36220605387](https://github.com/Truesilverking/TGym/actions/runs/36220605387) and [signed candidate 36220606984](https://github.com/Truesilverking/TGym/actions/runs/36220606984) all passed on this exact source.

Artifact `10898428968` was downloaded and verified: archive SHA-256 `b1ee501a8c400985b12c8901aea1d870ef8f842a6c23ba42386d8076583b6b91`, APK SHA-256 `2151ed64294c27f111e41c528b36e83b262f022dfcaaac3c63b02012c201c536`. Source, version/code and signing certificate match the candidate metadata and published signer. Candidate02 installation is held while awaiting the user's answer about the active phone workout, to avoid interrupting real training. Candidate01 does not contain the per-side correction. Its native WebView was observed within physical system-bar bounds, confirming native insets, but this does not verify the new rep UI on the phone.

Production remains 1.15.31; no production release/Pages/FCM update was sent. The phone's QA code67 already uses version name 1.15.32, and the JavaScript updater compares version names. It therefore needs direct replacement with code68; publishing the same version name alone will not offer that QA phone an upgrade. User workout data and private device screenshots are excluded from Git. Physical installation/visual verification remains pending; the local audit server was stopped.
